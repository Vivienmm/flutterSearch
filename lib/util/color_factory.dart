...
class LcfarmColor {
  ...
  static const Color colorChainBlue = const Color(0xff4F6EDD);
  ...
  static const Color sourceColor = const Color(0xffA0A0A0);
  static const Color chainTxtColor = const Color(0xff4C4C4C);
